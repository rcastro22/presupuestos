     ...
     <!-- <div class="container">-->
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="<?php echo $activo=='porproyecto'?'active':''; ?>"><a href="<?php echo base_url().'reportes/porproyecto/repXProyecto';?>">Reporte por proyecto</a></li>
            <li class="<?php echo $activo=='porempleado'?'active':''; ?>"><a href="<?php echo base_url().'reportes/porempleado/repXEmpleado';?>">Reporte por empleado</a></li>
            <li class="<?php echo $activo=='ejecutadomes'?'active':''; ?>"><a href="<?php echo base_url().'reportes/ejecutadomes/repEjecutadoMes';?>">Ejecutado por mes</a></li>
            <li class="<?php echo $activo=='detalleejecutado'?'active':''; ?>"><a href="<?php echo base_url().'reportes/detalleejecutado/repDetalleEjecutado';?>">Detalle Ejecutado</a></li>
          </ul>
