     ...
     <!-- <div class="container">-->
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="<?php echo $activo=='plantilla'?'active':''; ?>"><a href="<?php echo base_url().'catalogos/plantilla/listado';?>">Plantilla General</a></li>
            <li class="<?php echo $activo=='plantillaproyecto'?'active':''; ?>"><a href="<?php echo base_url().'catalogos/plantillaproyecto/listado';?>">Plantilla por Proyecto</a></li>
            <li class="<?php echo $activo=='empleado'?'active':''; ?>"><a href="<?php echo base_url().'catalogos/empleado/listado';?>">Empleado</a></li>
          </ul>
